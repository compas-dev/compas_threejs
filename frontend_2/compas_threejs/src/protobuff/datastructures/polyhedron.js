...
export class Polyhedron {
    ...
    constructor(input) {
        ...
        if (!polyhedronData.vertices || !polyhedronData.faces) {
            throw new Error("Invalid PolyhedronData: Missing required properties (vertices or faces).");
        }
...
export function bytesToPolyhedronData(bytes) {
    const polyhedronData = PolyhedronData.decode(bytes);
    return polyhedronData;
}
export function polyhedronDataToBytes(polyhedron) {
